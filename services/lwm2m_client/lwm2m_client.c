...
//#define SERVER_ADDR "23.97.187.154"
#define SERVER_ADDR "10.6.0.65"
...
static bool lwm2m_client_started;
...
int lwm2m_start_client(void)
{
    ...
    lwm2m_rd_client_start(&client, CONFIG_BOARD, flags, rd_client_event, NULL);
    return 0;
}
